...
<body>
	...
	<?php 
		...
		$sql = "INSERT INTO usuario (nome, cpf, senha, id_tipo) VALUES ('".$nome."', '".$cpf."', '".$senha."', '".$id_tipo."')";
		

			
		$sql2 = "INSERT INTO tipo_usuario (id_tipo, tipo, cpf) VALUES ('".$id_tipo."', 
			CASE 
	...
	?>      
        	<div class="jumbotron" id="cadastro">
